    <!-- Page Sub-Header with background dark blue -->
    <div id="page_header" class="page-subheader site-subheader-cst uh_flat_dark_blue ">
        ...
        <div class="kl-bg-source">
            <!-- Background image -->
            <div class="kl-bg-source__bgimage" style="background-image:url(public/images/sup_image/photocopies.jpg); background-repeat:no-repeat; background-attachment:scroll; background-position-x:center; background-position-y:center; background-size:cover"></div>
            <!--/ Background image -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="subheader-titles">
                                <!-- comment here -->
                                <!-- <h2 class="subheader-maintitle">We Have World Wide Customers</h2> -->
                                <!-- <h4 class="subheader-subtitle">Visit Our Main Office Branch Of Lahore.</h4> -->
                            </div>
                            <!--/ Sub-header titles -->
                        </div>
                        <!--/ col-sm-6 -->
